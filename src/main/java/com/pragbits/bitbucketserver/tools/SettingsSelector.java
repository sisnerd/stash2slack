...
public class SettingsSelector {
    ...
    private void setResolvedSlackSettings() {
        resolvedSlackSettings = new ImmutableSlackSettings(
                ...
                slackGlobalSettingsService.getSlackNotificationsRequireChannelName(),
                slackSettings.isSlackChannelNameEmpty() ? slackGlobalSettingsService.getChannelName() : slackSettings.getSlackChannelName(),
